...
# Module:        plant_response_engine.py
# Description:   Domain engine that computes a plant response.
#
...
class PlantResponseEngine:
    ...
    def compute(self, context: PlantResponseContext) -> tuple[
        ...
        t, y = plant.system_response(context.reference, context.t0, context.t1, context.dt, solver=context.solver)
        self._logger.info(
