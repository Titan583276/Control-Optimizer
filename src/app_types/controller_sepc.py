...
# Module:        controller_sepc.py
# Description:   Specification container for a controller type.
#
...
from app_domain.controlsys import ControllerType, AntiWindup
...
ff_pid_spec = ControllerSpec(
    ...
    build_controller_svg=c.get_ff_pid_controller_svg,
    build_closed_loop_svg=cl.ff_closed_loop_builder_svg,
    tf_controller=(
