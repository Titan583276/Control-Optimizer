...
class SettingsField(FieldType):
    ...
    PSO = "pso"
    PSO_REPEAT_RUNS = "pso_repeat_runs"
    PSO_SWARM_SIZE = "pso_swarm_size"
    PSO_RANDOMNESS = "pso_randomness"
    PSO_U1 = "pso_u1"
    PSO_U2 = "pso_u2"
    PSO_INITIAL_RANGE_START = "pso_initial_range_start"
    PSO_INITIAL_RANGE_END = "pso_initial_range_end"
    PSO_INITIAL_SWARM_SPAN = "pso_initial_swarm_span"
    PSO_MIN_NEIGHBORS_FRACTION = "pso_min_neighbors_fraction"
    PSO_MAX_STALL = "pso_max_stall"
