...
# Module:        evaluation_view.py
# Description:   View for evaluating control performance and visualizing
#                results.
#
...
class EvaluationView(ViewMixin, QWidget):
    ...
    def _build_block_diagram(self, use_color_mape: bool = True) -> str:
        ...
        return load_closed_loop_diagram(
            snapshot.controller_spec.build_closed_loop_svg,
            snapshot.controller_spec.build_controller_svg,
